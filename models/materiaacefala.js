...
const MateriaAcefalaSchema = new mongoose.Schema(
  {
    ...
    nivelAcademico: {
      ...
      enum: ["Grado", "Licenciatura", "Tecnológico", "Técnico"], // ✅ ACTUALIZADO: Corregido acento y agregado Técnico
    },
    carrera: {
      type: String,
      required: [true, 'El campo "carrera" es obligatorio'],
      enum: [
        // ✅ ACTUALIZADO: Agregadas las 5 nuevas carreras
        "Ciencias Básicas",
        "Materia Militar",
    ...
    motivosAcefalia: {
      type: String,
      required: [true, 'El campo "motivos de acefalia" es obligatorio'],
      trim: true,
    },
    createdAt: {
      type: Date,
